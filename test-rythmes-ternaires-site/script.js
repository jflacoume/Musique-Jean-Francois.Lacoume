...
const TILES = [
  { id:'r9', beats:2, onsets:[0],                                                       name:'Blanche pointée'},
  { id:'r8', beats:1, onsets:[0],                                                       name:'Noire pointée'},
  { id:'r7', beats:1, onsets:[0, 0.66666667],                                           name:'Noire-croche' },
  { id:'r6', beats:1, onsets:[0, 0.33333333],                                           name:'Croche-noire' },
  { id:'r5', beats:1, onsets:[0, 0.33333333, 0.66666667],                               name:'Trois croches' },
  { id:'r4', beats:1, onsets:[0, 0.16666667, 0.33333333, 0.5, 0.66666667],              name:'Quatre doubles-croche' },
  { id:'r3', beats:1, onsets:[0, 0.16666667, 0.33333333, 0.66666667],                   name:'Deux croches' },
  { id:'r1', beats:1, onsets:[0, 0.5, 0.66666667],                                      name:'Sicilienne' },
  { id:'r0', beats:1, onsets:[0, 0.16666667, 0.33333333, 0.5, 0.66666667, 0.83333333],  name:'Six doubles' },
  { id:'r2', beats:1, onsets:[0, 0.33333333, 0.66666667, 0.83333333],                   name:'Croche-croche-double-double' },
];
